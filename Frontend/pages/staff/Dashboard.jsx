  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-3 md:flex-row md:items-center">
        <div><h1 className="text-3xl font-black">Staff Dashboard</h1><p className="text-sm text-stone-500">Operational overview for incoming and active maintenance work.</p></div>
